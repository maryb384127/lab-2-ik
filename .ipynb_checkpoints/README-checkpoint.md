...
Upper_arm_length = 0.42500, forearm_length = 0.39225, wrist1 = 0.093, wrist2 = 0.09465 wrist3 = 0.0823 so if we add all these values we get 0.42500+0.39225+0.093+0.09465+0.0823=1.0872 so the maximum reach should be 1.0872 meters. However I think in testing this number will be different as the constraints restrict movement.
